...
All available methods and parameters are listed in our API https://neo4j.com/docs/graph-data-science-client/current/api/sessions/session_memory[reference].
...
Available configurations are listed in our API https://neo4j.com/docs/graph-data-science-client/current/api/sessions/session_memory[reference].

You can use the `sessions.estimate()` method to estimate the size required.
Available algorithm categories are listed in our API https://neo4j.com/docs/graph-data-science-client/current/api/sessions/algorithm_category[reference].
