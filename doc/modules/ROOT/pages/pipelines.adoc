...
While it is possible to operate pipelines using the same signatures as the Cypher procedures, the GDS Python Client offers a more convenient way by using the pipeline objects.
