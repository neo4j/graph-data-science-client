...
G, project_result = gds.graph.project.cypher(
    ...
    RETURN gds.graph.project(
        ...
        q,
        {
            sourceNodeProperties: { fraudster: p.fraudster },
            targetNodeProperties: { fraudster: q.fraudster },
            sourceNodeLabels: labels(p),
            targetNodeLabels: labels(q),
...
G, project_result = gds.graph.project.cypher(
    ...
    RETURN gds.graph.project(
        ...
        q,
        {
            sourceNodeProperties: { age: p.age },
            targetNodeProperties: { age: q.age },
            sourceNodeLabels: labels(p),
            targetNodeLabels: labels(q),
            relationshipType: type(r)
        }
