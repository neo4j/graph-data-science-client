...
We now continue the xref:pipelines.adoc#python-client-pipelines-nodeclassification-pipe-example[example above] using the node classification model `trained_pipe_model` we trained there.
...
We now continue the xref:pipelines.adoc#python-client-pipelines-linkprediction-pipe-example[example above] using the link prediction model `trained_pipe_model` we trained there.
Suppose that we have a new graph `H` that we want to run predictions on.
...
We now continue the xref:pipelines.adoc#python-client-pipelines-noderegression-pipe-example[example above] using the node regression model `trained_pipe_model` we trained there.
Suppose that we have a new graph `H` that we want to run predictions on.
