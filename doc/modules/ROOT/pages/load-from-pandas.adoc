...
The supported format for the node data frames is described in link:{gds-docs-base-uri}/graph-project-apache-arrow/#arrow-node-columns[Arrow node schema] and the format for the relationship data frames is described in link:{gds-docs-base-uri}/graph-project-apache-arrow/#arrow-relationship-columns[Arrow relationship schema].
...
NOTE: For Aura Graph Analytics and AuraDS, Apache Arrow is always enabled.
