...
For a detailed description of the allowed parameters, see the https://neo4j.com/docs/graph-data-science-client/{docs-version}/api/sessions/gds_sessions/#graphdatascience.session.gds_sessions.GdsSessions.estimate[API reference].
...
For full details and examples on how to write Cypher projection queries, see the link:{}/graph-data-science/current/management-ops/graph-creation/graph-project-cypher-projection/[Cypher projection documentation in the GDS Manual].
