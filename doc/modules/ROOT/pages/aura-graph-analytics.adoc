...
For a detailed description of the allowed parameters, see the https://neo4j.com/docs/graph-data-science-client/{docs-version}/api/sessions/gds_sessions/#graphdatascience.session.gds_sessions.GdsSessions.list[API reference].
...
For a full list of the available algorithms, see the link:https://neo4j.com/docs/graph-data-science-client/{page-version}/api/plugin/algorithms[API reference].
