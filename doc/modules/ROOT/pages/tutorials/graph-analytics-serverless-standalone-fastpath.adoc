...
embedding_df = gds.fast_path.stream(
    ...
    lookback_horizon=365 * 2,
    num_time_anchors=30,
    event_node_feature_vector_property="event_features",
    base_node_observation_time_property="output_time",
    event_node_time_property="event_time",
    smoothing_rate=0.9,
    smoothing_window=2,
    decay_rate=0.0,
)
