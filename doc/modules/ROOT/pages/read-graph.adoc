...
The methods to read node and relationship properties from a graph are the same as in the Cypher API (see link:{gds-docs-base-uri}/management-ops/graph-reads/graph-stream-nodes/[Streaming nodes] and link:{gds-docs-base-uri}/management-ops/graph-reads/graph-stream-relationships/[Streaming relationships]).
