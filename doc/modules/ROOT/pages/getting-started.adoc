...
This method takes as parameters a query string (`str`), an optional Cypher parameters dictionary (`Optional[Dict[str, Any]]]`) as well as an optional string (`Optional[str]`) to override which database to target.
