...
=====
If you are connecting to a Neo4j database with the link:{gds-docs-base-uri}/installation/neo4j-server/[GDS Plugin] installed.
...
AuraDS instances always use the lastest version of GDS.
=====
====
