...
[[graph-object-load-cora]]
=== Loading the CORA dataset

For convenience, the library is shipped with the https://paperswithcode.com/dataset/cora[CORA dataset].
...
[source,python,group=graph-project]
----
result = gds.graph.streamNodeProperty(G, node_properties="degree")
