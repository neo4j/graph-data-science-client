...
The method returns a link:{gds-api-uri}/endpoints/kge_endpoints/#graphdatascience.procedure_surface.api.kge.kge_predict_endpoints.KgeMutateResult[`KgeMutateResult`] object with metadata about the computation, whose fields are accessed as attributes:
