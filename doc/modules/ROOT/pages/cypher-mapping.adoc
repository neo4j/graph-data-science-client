...
** The xref:graph-object.adoc[graph object] can be used to inspect graphs from the link:{gds-docs-base-uri}/management-ops/graph-catalog-ops/[GDS graph catalog].
** The xref:model-object.adoc[model object] can be used to inspect models from the link:{gds-docs-base-uri}/model-catalog/[GDS model catalog].
