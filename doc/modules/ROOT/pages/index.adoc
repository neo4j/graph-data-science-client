...
For a high level explanation of how the Cypher API maps to the Python client API please see xref:getting-started.adoc#python-client-getting-started-mapping[Mapping between Cypher and Python].
