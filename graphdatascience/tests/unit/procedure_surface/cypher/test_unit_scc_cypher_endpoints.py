...
from graphdatascience.procedure_surface.api.community.scc_endpoints import SccMutateResult, SccStatsResult, SccWriteResult
...
@pytest.fixture
def graph() -> GraphV2:
    return get_graph("test_graph", CollectingQueryRunner(DEFAULT_SERVER_VERSION))
