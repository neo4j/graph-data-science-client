...
def test_k1coloring_stats(k1coloring_endpoints: K1ColoringCypherEndpoints, sample_graph: Graph) -> None:
...
def test_k1coloring_stream(k1coloring_endpoints: K1ColoringCypherEndpoints, sample_graph: Graph) -> None:
...
def test_k1coloring_mutate(k1coloring_endpoints: K1ColoringCypherEndpoints, sample_graph: Graph) -> None:
...
def test_k1coloring_estimate(k1coloring_endpoints: K1ColoringCypherEndpoints, sample_graph: Graph) -> None:
