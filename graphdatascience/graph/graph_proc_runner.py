...
class GraphProcRunner(CallerBase, UncallableNamespace, IllegalAttrChecker):
    ...
    def load_imdb(self, graph_name: str = "cora") -> Graph:
        ...
        for spmatrix in spmatrices:
            ...
            edge_list.append(
                adj_matrix.iloc[:, :-1].rename(columns={"level_0": "sourceNodeId", "level_1": "targetNodeId"})
            )
        ...
        return self.construct(graph_name, [movie_nodes_with_features, person_nodes_with_features], labeled_rels)
