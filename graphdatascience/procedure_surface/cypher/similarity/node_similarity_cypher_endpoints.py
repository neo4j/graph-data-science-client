...
class NodeSimilarityCypherEndpoints(NodeSimilarityEndpoints):
    def __init__(self, query_runner: QueryRunner):
        self._query_runner = query_runner

    @property
    def filtered(self) -> NodeSimilarityFilteredEndpoints:
        return NodeSimilarityFilteredCypherEndpoints(self._query_runner)
    ...
    def mutate(
        ...
        result = self._query_runner.call_procedure("gds.nodeSimilarity.mutate", params=params).iloc[0]
    ...
    def stats(
        ...
        result = self._query_runner.call_procedure(
            "gds.nodeSimilarity.stats", params=params, logging=log_progress
        ).iloc[0]
    ...
    def stream(
        ...
        return self._query_runner.call_procedure("gds.nodeSimilarity.stream", params=params, logging=log_progress)
    ...
    def write(
        ...
        result = self._query_runner.call_procedure(
            "gds.nodeSimilarity.write", params=params, logging=log_progress
        ).iloc[0]
    ...
    def estimate(
        ...
        return estimate_algorithm("gds.nodeSimilarity.stats.estimate", self._query_runner, G, config)
