...
@pytest.fixture
def gs_model(query_runner: QueryRunner, sample_graph: Graph) -> Generator[GraphSageModel, None, None]:
...
def test_write(gs_model: GraphSageModel, sample_graph: Graph) -> None:
