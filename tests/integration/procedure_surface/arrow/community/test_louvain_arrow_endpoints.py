...
def test_louvain_write(arrow_client: AuthenticatedArrowClient, query_runner: QueryRunner, db_graph: Graph) -> None:
    ...
    endpoints = LouvainArrowEndpoints(arrow_client, WriteProtocol.select(arrow_client, query_runner))
...
def test_compute(louvain_endpoints: LouvainArrowEndpoints, sample_graph: Graph) -> None:
