...
def test_bridges_stream(bridges_endpoints: BridgesArrowEndpoints, sample_graph: Graph) -> None:
...
def test_bridges_estimate(bridges_endpoints: BridgesArrowEndpoints, sample_graph: Graph) -> None:
...
def test_compute(bridges_endpoints: BridgesArrowEndpoints, sample_graph: Graph) -> None:
