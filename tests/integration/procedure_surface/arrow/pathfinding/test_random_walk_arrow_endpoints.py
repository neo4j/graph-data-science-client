...
def test_random_walk_stream(random_walk_endpoints: RandomWalkArrowEndpoints, sample_graph: Graph) -> None:
    result_df = random_walk_endpoints.stream(G=sample_graph, walks_per_node=2, walk_length=4, random_seed=42)

    assert len(result_df) > 0


def test_random_walk_mutate(random_walk_endpoints: RandomWalkArrowEndpoints, sample_graph: Graph) -> None:
...
def test_random_walk_stats(random_walk_endpoints: RandomWalkArrowEndpoints, sample_graph: Graph) -> None:
    result = random_walk_endpoints.stats(G=sample_graph, walks_per_node=1, walk_length=3, random_seed=42)

    assert result.compute_millis >= 0


def test_random_walk_estimate(random_walk_endpoints: RandomWalkArrowEndpoints, sample_graph: Graph) -> None:
...
def test_compute(random_walk_endpoints: RandomWalkArrowEndpoints, sample_graph: Graph) -> None:
