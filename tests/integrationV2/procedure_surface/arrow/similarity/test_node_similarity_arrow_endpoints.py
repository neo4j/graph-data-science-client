...
def test_compute_summary_and_stream(ns_endpoints: NodeSimilarityArrowEndpoints, sample_graph: GraphV2) -> None:
    handle = ns_endpoints.compute(G=sample_graph, top_k=2)
