...
def test_bfs_stream(bfs_endpoints: BFSArrowEndpoints, sample_graph: Graph) -> None:
...
def test_bfs_mutate(bfs_endpoints: BFSArrowEndpoints, sample_graph: Graph) -> None:
...
def test_bfs_estimate(bfs_endpoints: BFSArrowEndpoints, sample_graph: Graph) -> None:
...
def test_bfs_stats(bfs_endpoints: BFSArrowEndpoints, sample_graph: Graph) -> None:
...
def test_compute(bfs_endpoints: BFSArrowEndpoints, sample_graph: Graph) -> None:
