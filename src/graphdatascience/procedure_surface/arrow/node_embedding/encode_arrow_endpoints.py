...
from graphdatascience.procedure_surface.api.node_embedding.config import FastRPConfig, IdentityConfig
...
class EncodeArrowEndpoints(EncodeEndpoints):
    ...
    def compute(
        ...
        *,
        ...
        return self._endpoints_helper.run_job(G, "v2/embeddings.encode", config)
    ...
    def stream(
        ...
        *,
        ...
        return self._endpoints_helper.run_job_and_stream("v2/embeddings.encode", G, config)
    ...
    def stats(
        ...
        *,
        ...
        result = self._endpoints_helper.run_job_and_get_summary("v2/embeddings.encode", config)
    ...
    def write(
        ...
        *,
        ...
        result = self._endpoints_helper.run_job_and_write(
            "v2/embeddings.encode", G, config, write_property, write_concurrency
        )
