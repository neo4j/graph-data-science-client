...
class SteinerTreeArrowEndpoints(SteinerTreeEndpoints):
    ...
    def compute(
        ...
        *,
        ...
        return self._endpoints_helper.run_job(G, "v2/pathfinding.steinerTree", config)
    ...
    def stream(
        ...
        return self._endpoints_helper.run_job_and_stream("v2/pathfinding.steinerTree", G, config)
