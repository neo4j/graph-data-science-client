...
class SourceTargetDijkstraArrowEndpoints(SourceTargetDijkstraEndpoints):
    def __init__(
        self,
    ...
    def compute(
        ...
        *,
        ...
        return self._endpoints_helper.run_job(G, "v2/pathfinding.sourceTarget.dijkstra", config)
    ...
    def mutate(
        ...
        result = self._endpoints_helper.run_job_and_mutate(
            "v2/pathfinding.sourceTarget.dijkstra",
            config,
    ...
    def estimate(
        ...
        return self._endpoints_helper.estimate("v2/pathfinding.sourceTarget.dijkstra.estimate", G, config)
