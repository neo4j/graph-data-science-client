...
class YensCypherEndpoints(SourceTargetYensEndpoints):
    ...
    def stream(
        ...
        return self._query_runner.call_procedure(
            ...
            yields=["sourceNode", "targetNode", "totalCost", "nodeIds", "costs", "index"],
        )
    ...
    def estimate(
        ...
        return estimate_algorithm("gds.shortestPath.yens.stream.estimate", self._query_runner, G, config)
