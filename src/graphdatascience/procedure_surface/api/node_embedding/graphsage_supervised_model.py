...
class GraphSageSupervisedModel(Model):
    """
    Represents a supervised (node classification) GraphSage model in the model catalog.
    Construct this using `gds.graph_sage.supervised.train`.
    """

    def __init__(
        self, name: str, catalog: ModelCatalogProtocol, predict_endpoints: GraphSageSupervisedEndpoints
    ) -> None:
    ...
    def predict_stream(
        ...
        *,
        ...
        """
        Predict classes for the given graph and stream the results.

        Parameters
        ----------
        G
            The graph to predict classes for.
        feature_properties
        ...
        -------
        pandas.DataFrame
            The streaming results as a DataFrame with node IDs, predicted classes and predicted class probabilities.
        """
    ...
    def predict_write(
        ...
        *,
        ...
        feature_properties
            Names of the node properties to use as input features
        write_property
            The property to write the predicted classes to.
        predicted_probability_property
            The property to write the predicted class probabilities to.
        batch_size
            Number of nodes to process in each batch.
        random_seed
            Seed for random number generation to ensure reproducible results.
    ...
    def predict_mutate(
        ...
        *,
        ...
        feature_properties
            Names of the node properties to use as input features
        mutate_property
            The property to mutate with the predicted classes.
        predicted_probability_property
            The property to mutate with the predicted class probabilities.
        batch_size
            Number of nodes to process in each batch.
        random_seed
            Seed for random number generation to ensure reproducible results.
